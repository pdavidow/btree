    ...
    describe "BTreeVariedType module"
         ...
         , describe "BTreeVariedType.deDuplicate"
            ...
            , test "of MusicNoteNode" <|
                \() ->
                     Expect.equal (BTreeVaried <| Node (toMusicNoteVariety <| MusicNotePlayer.on B) (singleton <| toMusicNoteVariety (MusicNotePlayer.on A)) Empty) (BTreeVariedType.deDuplicate (BTreeVaried <| Node (toMusicNoteVariety <| MusicNotePlayer.on B) (singleton <| toMusicNoteVariety <| MusicNotePlayer.on B) (singleton <| toMusicNoteVariety <| MusicNotePlayer.on A)))
            , test "of NothingNode" <|
                \() ->
         ...
         , describe "BTreeVariedType.hasAnyIntNodes"
            ...
            , test "of 4 values, including IntNode but not BigIntNode" <|
                \() ->
                    Expect.equal True (BTreeVariedType.hasAnyIntNodes (BTreeVaried <| Node (toStringVariety <| "abcde") (singleton <| toIntVariety <| Safe 2) (Node (toMusicNoteVariety <| MusicNotePlayer.on E) (singleton <| toBoolVariety <| Just True) Empty)))
            , test "of 4 values, neither including IntNode, nor BigIntNode" <|
                \() ->
                    Expect.equal False (BTreeVariedType.hasAnyIntNodes (BTreeVaried <| Node (toStringVariety "abcde") (singleton <| toBoolVariety <| Just False) (Node (toMusicNoteVariety <| MusicNotePlayer.on E) (singleton <| toBoolVariety <| Just True) Empty)))
            ...
            , test "of 4 values, including BigIntNode but not IntNode" <|
                \() ->
                    Expect.equal True (BTreeVariedType.hasAnyIntNodes (BTreeVaried <| Node (toStringVariety "abcde") (singleton <| toBigIntVariety <| BigInt.fromInt 2) (Node (toMusicNoteVariety <| MusicNotePlayer.on E) (singleton <| toBoolVariety <| Just True) Empty)))
            ]         
        ]
