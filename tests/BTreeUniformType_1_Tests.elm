            ...
            , test "of non-empty.BTreeMusicNotePlayer.1" <|
                \() ->
                    Expect.equal
                        ...
                        ( BTreeUniformType.toTaggedNodes <| BTreeMusicNotePlayer <| singleton <| MusicNoteNodeVal <| MusicNotePlayer.on A
                        )
            ...
            ,  test "of non-empty.BTreeInt.3" <|
                \() ->
                    Expect.equal
                        ...
                        ( BTreeUniformType.toLength <| BTreeInt <| singleton <| IntNodeVal <| toMaybeSafeInt <| maxSafeInt + 1
                        )
            ,  test "of non-empty.BTreeBigInt.1" <|
                \() ->
                    Expect.equal
            ...
            ,  test "of non-empty.BTreeBigInt.3" <|
                \() ->
                    Expect.equal
                        ...
                        ( BTreeUniformType.toLength <| BTreeBigInt <| singleton <| BigIntNodeVal <| BigInt.fromInt <| maxSafeInt + 1
                        )
            ,  test "of non-empty.BTreeString.1" <|
                \() ->
                    Expect.equal
            ...
            ,  test "of non-empty.BTreeMusicNotePlayer.1" <|
                \() ->
                    Expect.equal
                        ...
                        ( BTreeUniformType.toLength <| BTreeMusicNotePlayer <| singleton <| MusicNoteNodeVal <| MusicNotePlayer.on A
                        )
            ,  test "of non-empty.BTreeNothing.1" <|
                \() ->
                    Expect.equal
            ...
            , test "of non-empty.BTreeInt.1" <|
                \() ->
                    Expect.equal
                        ...
                        ( BTreeUniformType.toIsIntPrime <| BTreeInt <| singleton <| IntNodeVal <| toMaybeSafeInt <| maxSafeInt + 1
                        )
            , test "of non-empty.BTreeInt.2" <|
                \() ->
                    Expect.equal
                        ...
                        ( BTreeUniformType.toIsIntPrime <| BTreeInt <| singleton <| IntNodeVal <| toMaybeSafeInt <| negate <| maxSafeInt
                        )
            , test "of non-empty.BTreeInt.3" <|
                \() ->
                    Expect.equal
            ...
            , test "of non-empty.BTreeMusicNotePlayer.1" <|
                \() ->
                    Expect.equal
                        ...
                        ( BTreeUniformType.toIsIntPrime <| BTreeMusicNotePlayer <| singleton <| MusicNoteNodeVal <| MusicNotePlayer.on A
                        )
            , test "of non-empty.BTreeNothing.1" <|
                \() ->
                    Expect.equal
